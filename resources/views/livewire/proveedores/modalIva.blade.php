<div class="modal fade" id="modalAddIva" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Agregar Condición de Iva</h5>
        </div>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary saveTarifa" type="button" onclick="saveIva()">Guardar</button>
        </div>
    </div>
</div>
</div>