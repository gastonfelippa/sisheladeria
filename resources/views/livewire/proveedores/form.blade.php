<div class="col-12 layout-spacing">
		<div class="widget-content-area">
            <div class="widget-one">
                <h5><b>@if($selected_id ==0) Crear Nuevo Proveedor @else Editar Proveedor @endif</b></h5>
                @include('common.alerts') <!-- mensajes ok/error-->
                @include('common.messages') <!-- mensajes validaciones -->
                <div class="row mt-3">                               
                    ...
                    <div class="col-12 col-md-4 layout-spacing">
                        <div class="input-group ">
                            ...
                            <select wire:model="condIvaId" class="form-control text-center">
