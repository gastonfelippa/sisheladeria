...
<div class="col-12 layout-spacing"> 
	<div class="widget-content-area">
        <div class="widget-one">
            <h5><b>@if($selected_id ==0) Crear Nuevo Cliente  @else Editar Cliente @endif</b></h5>
            ...
            <div class="row mt-3">                               
                <div class="col-12 col-md-6 layout-spacing">
                    <div class="input-group">
                        ...
                        <input id="nombre" type="text" class="form-control text-uppercase" placeholder="Nombre" wire:model.lazy="nombre" autofocus>
                    </div>
                </div>
                <div class="col-12 col-md-6 layout-spacing">
                    <div class="input-group">
