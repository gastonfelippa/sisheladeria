                    ...
                    <div class="row mt-3">                               
                        <div class="col-12 layout-spacing">
                            <div class="input-group ">
                                ...
                                <input id="descripcion" type="text" class="form-control text-uppercase" placeholder="Nombre" autofocus autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">                               
                        <div class="col-12 layout-spacing">
                            <div class="input-group ">
                                ...
                                <input id="margen" type="text" class="form-control" placeholder="Margen de ganancia">
                            </div>
                        </div>
                    </div>
                </div>
