<div class="modal fade" id="modalRubros" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
                        ...
                        <div class="row">                          
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="descripcion" type="text" class="form-control text-capitalize" placeholder="Descripción">
                                </div>                             
                            </div>
                        </div>
                        <div class="row">                          
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="margen" type="text" class="form-control" placeholder="Margen">
                                </div>                             
                            </div>
                        </div>
                    </form>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary saveTarifa" type="button" onclick="saveRubro()">Guardar</button>
        </div>
    </div>
</div>
</div>